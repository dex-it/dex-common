...
public static class MicrosoftDependencyInjectionExtensions
{
        ...
        where TDistributedCache : class, IDistributedCache
    {
        ...
        return services
            .AddScoped(typeof(IOnceExecutor<IMemoryOptions, IDistributedCache>), typeof(OnceExecutorMemory<TDistributedCache>))
            .AddScoped(typeof(IOnceExecutor<IMemoryOptions>), typeof(OnceExecutorMemory<TDistributedCache>));
    }
}