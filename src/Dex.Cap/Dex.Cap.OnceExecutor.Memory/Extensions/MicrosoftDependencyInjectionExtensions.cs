...
public static class MicrosoftDependencyInjectionExtensions
{
        ...
        where TDistributedCache : class, IDistributedCache
    {
        ...
        return services
            .AddScoped(typeof(IOnceExecutor<IDistributedCache>), typeof(OnceExecutorMemory<TDistributedCache>))
            .AddScoped(typeof(IOnceExecutor), typeof(OnceExecutorMemory<TDistributedCache>));
    }
}