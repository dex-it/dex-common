...
/// двух типов или пустой дискриминатор. Без этого сервиса реестр строился бы лениво, уже внутри фонового
/// обработчика, где цикл перехватывает исключение и пишет LogCritical: хост считался бы поднятым, а
/// инбокс молча не обрабатывал бы ничего.
/// <para>
