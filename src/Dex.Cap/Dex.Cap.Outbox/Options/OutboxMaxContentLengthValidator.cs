...
/// <summary>
/// Проверяет единственное правило: <see cref="OutboxOptions.MaxContentLength"/> положителен.
/// </summary>
/// <remarks>
...
/// </remarks>
internal sealed class OutboxMaxContentLengthValidator : IValidateOptions<OutboxOptions>
{
    public ValidateOptionsResult Validate(string? name, OutboxOptions options)
    {
        ...
        return options.MaxContentLength <= 0
            ? ValidateOptionsResult.Fail(
                $"{nameof(OutboxOptions)}.{nameof(OutboxOptions.MaxContentLength)} should be a positive number, " +
