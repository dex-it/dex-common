...
public class OutboxEnvelope
{
    ...
    /// </summary>
    /// <remarks>
    /// Размер тела ограничен сверху опцией <see cref="Options.OutboxOptions.MaxContentLengthBytes"/> (по
    ...
    /// </summary>
    /// <remarks>Если превышен этот момент времени то допускается повторный захват блокировки несмотря на значение <see cref="LockId"/>.</remarks>
