...
public class InboxEnvelope
{
    ...
    /// <see cref="ConsumerId"/>, чей предел продиктован уникальным индексом, здесь предел про объём хранения:
    /// тело приходит от внешнего источника и лежит весь ретеншен, поэтому аномально большой payload раздувает
    /// таблицу и бэкап.
    /// </remarks>
    [Required]
