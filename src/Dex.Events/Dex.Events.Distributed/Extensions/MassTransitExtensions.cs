...
namespace Dex.Events.Distributed.Extensions
{
    public static class MassTransitExtensions
    {
        ...
        public static void SubscribeEventHandlers<T, TH1>(this IReceiveConfigurator<IReceiveEndpointConfigurator> configurator,
        ...
        public static void SubscribeEventHandlers<T, TH1, TH2>(this IReceiveConfigurator<IReceiveEndpointConfigurator> configurator,
            IBusRegistrationContext registrationContext, string? serviceName = null)
            where T : DistributedBaseEventParams
            where TH1 : IDistributedEventHandler<T>
            where TH2 : IDistributedEventHandler<T>
        {
            ...
            configurator.SubscribeEventHandlers<T, TH1>(registrationContext, serviceName);
            configurator.SubscribeEventHandlers<T, TH2>(registrationContext, serviceName);
        }
        ...
        public static void SubscribeEventHandlers<T, TH1, TH2, TH3>(this IReceiveConfigurator<IReceiveEndpointConfigurator> configurator,
            IBusRegistrationContext registrationContext, string? serviceName = null)
            where T : DistributedBaseEventParams
            where TH1 : IDistributedEventHandler<T>
            where TH2 : IDistributedEventHandler<T>
            where TH3 : IDistributedEventHandler<T>
        {
            ...
            configurator.SubscribeEventHandlers<T, TH1>(registrationContext, serviceName);
            configurator.SubscribeEventHandlers<T, TH2>(registrationContext, serviceName);
            configurator.SubscribeEventHandlers<T, TH3>(registrationContext, serviceName);
        }
    }
}