...
|---|---|---|
| Dex.Cap | Outbox (транзакционная публикация) + Inbox (приём с дедупликацией) + OnceExecutor (идемпотентность) | `src/Dex.Cap/CLAUDE.md` |
...
Весь код должен соответствовать [.NET Runtime Coding Guidelines](https://github.com/dotnet/runtime/tree/main/docs/coding-guidelines): именование, форматирование, структура типов, использование языковых конструкций. При расхождении с локальным .editorconfig приоритет у .editorconfig.
